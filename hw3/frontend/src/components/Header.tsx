      ...
      <header className="sticky top-0 z-40 bg-slate-950/80 text-slate-50 backdrop-blur border-b border-slate-900">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
          ...
          <div className="hidden items-center gap-2 md:flex">
            ...
            <span className="hidden items-center gap-2 rounded-full border border-green-500/60 bg-green-500/10 px-3 py-2 text-xs uppercase tracking-[0.14em] text-green-100 md:inline-flex">
              <Sparkles size={16} />
              Deployed to AWS CloudFront Using CDK
            </span>
          </div>
        </div>
      </header>
